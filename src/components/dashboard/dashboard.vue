<template>
    ...
    <Table border :columns="availableplugins" :data="availablepluginsdata"></Table>
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                data:null,
                availableplugins:[
                        {title:"plugin",key:"plugin",width: 250},{width: 100,title:"enable",key:"enable"}

                ],
                availablepluginsdata:[]
                ,
                serverstatus:[
                        {title:"item",key:"item",width: 300},{width: 450,title:"value",key:"value"}
    ...
    created: function () {
       ...
       this.axios.get("http://172.16.2.39:50001/")
                    ...
                    .then(response => {
                        if(response.status = "200")
                        {
                            ...
                            var newdata = []
                            Object.keys(response.data.plugins.available_on_server).forEach(function (key){
                                        newdata.push({plugin:key,enable:response.data.plugins.available_on_server[key]})
                            })
                            ...
                            Object.keys(response.data.configuration).forEach(function (key){
                                        ...
                                        newdata.push({item:key,value:response.data.configuration[key]})
                            })
        ...
        methods: {
            ...
            querybillloans() {
                ...
                this.axios.post(uri, {
                        ...
                        "sql": "select * from user_loan where user_bill_id = ( select id from user_bill where proxy_serial_no = '" + this.billkey + "')"
            ...
            queryloansbill() {
                ...
                this.axios.post(uri, {
                        ...
                        "sql": "select * from user_bill where id = ( select user_bill_id from user_loan where partner_loan_no = '" + this.partnerloanno + "')"
